...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tomonotomo_usertomonotomo', 'interests', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'UserTomonotomo.interests'
        db.alter_column(u'tomonotomo_usertomonotomo', 'interests', self.gf('django.db.models.fields.CharField')(max_length=20000L, null=True))
