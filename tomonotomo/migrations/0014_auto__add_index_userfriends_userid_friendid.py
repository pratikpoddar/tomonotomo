...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserFriends', fields ['userid', 'friendid']
        db.create_index(u'tomonotomo_userfriends', ['userid_id', 'friendid'])


    def backwards(self, orm):
        # Removing index on 'UserFriends', fields ['userid', 'friendid']
        db.delete_index(u'tomonotomo_userfriends', ['userid_id', 'friendid'])
    ...
    models = {
        ...
        u'tomonotomo.userfriends': {
            'Meta': {'unique_together': "(('userid', 'friendid'),)", 'object_name': 'UserFriends', 'index_together': "[['userid', 'friendid']]"},
