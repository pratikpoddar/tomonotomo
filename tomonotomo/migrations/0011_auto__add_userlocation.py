...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tomonotomo_userlocation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('locationid', self.gf('django.db.models.fields.BigIntegerField')(unique=True, db_index=True)),
            ('userlocation', self.gf('django.db.models.fields.CharField')(max_length=100L, db_index=True)),
        ...
        db.send_create_signal(u'tomonotomo', ['UserLocation'])


    def backwards(self, orm):
        # Deleting model 'UserLocation'
        db.delete_table(u'tomonotomo_userlocation')
