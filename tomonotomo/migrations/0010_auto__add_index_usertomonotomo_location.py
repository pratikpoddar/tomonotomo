...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserTomonotomo', fields ['location']
        db.create_index(u'tomonotomo_usertomonotomo', ['location'])


    def backwards(self, orm):
        # Removing index on 'UserTomonotomo', fields ['location']
        db.delete_index(u'tomonotomo_usertomonotomo', ['location'])
