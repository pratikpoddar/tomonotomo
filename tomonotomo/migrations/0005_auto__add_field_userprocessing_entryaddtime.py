...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProcessing.entryaddtime'
        db.add_column(u'tomonotomo_userprocessing', 'entryaddtime',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProcessing.entryaddtime'
        db.delete_column(u'tomonotomo_userprocessing', 'entryaddtime')
