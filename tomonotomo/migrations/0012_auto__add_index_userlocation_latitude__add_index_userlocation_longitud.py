...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'UserLocation', fields ['latitude']
        db.create_index(u'tomonotomo_userlocation', ['latitude'])

        # Adding index on 'UserLocation', fields ['longitude']
        db.create_index(u'tomonotomo_userlocation', ['longitude'])


    def backwards(self, orm):
        # Removing index on 'UserLocation', fields ['longitude']
        db.delete_index(u'tomonotomo_userlocation', ['longitude'])

        # Removing index on 'UserLocation', fields ['latitude']
        db.delete_index(u'tomonotomo_userlocation', ['latitude'])
