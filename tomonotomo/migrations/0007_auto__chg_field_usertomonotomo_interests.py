...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserTomonotomo.interests'
        db.alter_column(u'tomonotomo_usertomonotomo', 'interests', self.gf('django.db.models.fields.CharField')(max_length=10000L, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserTomonotomo.interests'
        raise RuntimeError("Cannot reverse this migration. 'UserTomonotomo.interests' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserTomonotomo.interests'
        db.alter_column(u'tomonotomo_usertomonotomo', 'interests', self.gf('django.db.models.fields.CharField')(max_length=10000L))
    ...
    models = {
        ...
        u'tomonotomo.usertomonotomo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interests': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10000L', 'null': 'True'}),
