...
FACEBOOK_EXTENDED_PERMISSIONS= ['email', 'user_birthday', 'user_relationships', 'friends_relationships', 'friends_birthday', 'friends_education_history', 'friends_work_history', 'friends_hometown', 'friends_location' ]
